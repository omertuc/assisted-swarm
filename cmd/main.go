...
import (
	...
	"github.com/openshift-assisted/assisted-swarm/restapi"
	"github.com/openshift-assisted/assisted-swarm/src/api"
...
func main() {
	util.SetLogging("combined-agent", false, true, true, MainDummyHostID)
	failOnError := func(err error, msg string, args ...any) {
		if err != nil {
